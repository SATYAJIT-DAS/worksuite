<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('super-admin.company-groups.index') }}" class="waves-effect"><i class="fa fa-users fa-fw"></i> <span class="hide-menu">@lang('app.menu.CompanyGroup') </span></a> </li>
